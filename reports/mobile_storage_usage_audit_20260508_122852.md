...
- Genere le: 2026-05-08 12:28:52
- Base Django: `SRM_bureau`
- Tables SQLite statiques detectees: `16`
- Entites metier SrmConfig detectees: `43`
- Endpoints mobiles API detectes: `48`
...
| Source | Nombre |
| --- | --- |
| SrmConfig ep/asst/elec | {'ep': 26, 'asst': 17} |
| Endpoints API | 48 |
| Static SQLite | 16 |
...
| Table physique | Titre | Ordre | Visible | Champs visibles/total | Table locale SrmConfig | Endpoint |
| --- | --- | --- | --- | --- | --- | --- |
| asst.ASS_REGARD | Regards de visite | 1 | true | 18/68 | asst_regard | yes |
| asst.ASS_REGARD_FACADE | Regards Façade | 2 | true | 0/59 | asst_regard_branchement | yes |
| asst.ASS_BORGNE | Regards Borgnes | 3 | true | 0/66 | ASS_BORGNE | yes |
| asst.ASS_BOUCHE | Bouches d'égout | 4 | true | 0/52 | ASS_BOUCHE | yes |
| asst.ASS_DEVERSOIR | Déversoirs d'orage | 5 | true | 0/73 | ASS_DEVERSOIR | yes |
| asst.ASS__EXUTOIRE | Exutoires | 6 | true | 0/61 | ASS__EXUTOIRE | yes |
| asst.ASS_STA_POMP | Stations de pompage | 7 | true | 0/56 | asst_station | yes |
| asst.ASS_COLLECTEUR | Collecteurs | 8 | true | 12/71 | asst_canalisation | yes |
| asst.ASS_BRANCHEMENT | Branchements collecteur | 9 | true | 9/49 | asst_branchement | yes |
| asst.ASS_CANIVEAU | Caniveaux | 10 | true | 0/51 | ASS_CANIVEAU | yes |
| asst.ASS_CANIV_BRANCHE | Caniveau branchement | 11 | true | 0/49 | ASS_CANIV_BRANCHE | yes |
| asst.ASS_COL_BOUCHE | Collecteur bouche d'égout | 12 | true | 0/71 | ASS_COL_BOUCHE | yes |
| asst.ASS_BASSIN_VERSANT | Bassins versants | 13 | false | 0/32 | asst_bassin | yes |
| asst.ASS_STA_EPUR | Stations d'épuration | 14 | true | 14/55 | ASS_STA_EPUR | yes |
| asst.ASS_BASSIN_RET | Bassins de rétention | 15 | false | 0/56 | - | no |
| asst.ASS_BASSIN_RET_L | Bassins de rétention (ligne) | 16 | false | 0/32 | - | no |
| asst.ASS_ECOULEMENT | Écoulement | 17 | false | 0/26 | - | no |
| asst.ASS_FOSSE_SEPT | Fosses septiques | 18 | false | 0/57 | - | no |
| asst.ASS_OUED | Oued | 19 | false | 0/22 | - | no |
| asst.ASS_OUV_TRAVERSEE | Ouvrages de traversée | 20 | false | 0/66 | asst_ouvrage | yes |
| asst.ASS_POINTS-NOIRS | Points noirs | 21 | false | 0/65 | - | no |
| asst.ASS_POMPE | Pompes | 22 | false | 0/44 | asst_equipement | yes |
| asst.ASS_REFOULEMENTR | Refoulement réutilisation | 23 | false | 0/68 | asst_canalisation_reutilisation | yes |
| asst.ASS_SECTEUR_ASS | Secteurs assainissement | 24 | false | 0/31 | - | no |
| asst.ASS_STA_EPUR_L | Stations d'épuration (ligne) | 25 | false | 0/43 | - | no |
| asst.ASS_STA_POMP_S | Stations de pompage (surface) | 26 | false | 0/54 | - | no |
| ep.ep_regard_point | Regard | 1 | true | 16/68 | ep_regard_point | yes |
| ep.conduite_terrain | Conduite terrain | 2 | true | 2/53 | conduite_terrain | yes |
| ep.ep_conduite | Conduite bureau | 3 | false | 0/83 | - | yes |
| ep.ep_brc_pt | Compteur abonné | 4 | true | 15/62 | compteur_abonne | yes |
| ep.ep_bf | Borne fontaine | 5 | true | 17/70 | borne_fontaine | yes |
| ep.ep_traversee | Traversée | 6 | true | 13/59 | traverse | yes |
| ep.ep_cone_reduc | Cône de réduction | 7 | true | 8/55 | cone_de_reduction | yes |
| ep.ep_compteur_i | Compteur réseau | 8 | true | 10/64 | compteur_reseau | yes |
| ep.ep_hydrant | Hydrant | 9 | true | 17/69 | hydrant | yes |
| ep.ep_vanne | Vanne | 10 | true | 15/63 | vanne | yes |
| ep.ep_obturateur | Obturateur | 11 | true | 5/44 | obturateur | yes |
| ep.ep_branchement | Branchement | 12 | false | 7/43 | branchement | yes |
| ep.ep_bache | Bâche | 13 | true | 9/51 | - | no |
| ep.ep_bouche_arro | Bouche d'arrosage | 14 | false | 4/51 | bouche_darrosage | yes |
| ep.ep_vidange | Vanne de vidange | 15 | true | 13/58 | vanne_de_vidange | yes |
| ep.ep_ventouse | Ventouse | 16 | true | 11/57 | ventouse | yes |
| ep.ep_reduc_pres | Réducteur de pression | 17 | true | 8/62 | reducteur_de_pression | yes |
| ep.voie | Voie | 18 | true | 1/17 | - | no |
| ep.centre_tampon | Centre tampon | 19 | false | 2/26 | centre_tampon | yes |
| ep.ep_reservoir | Réservoir | 20 | true | 17/69 | reservoir | yes |
| ep.ep_forage | Forage | 21 | true | 15/62 | forage | yes |
| ep.ep_noeud | Noeud | 22 | false | 2/39 | noeud | yes |
| ep.ep_pompe | Pompe | 23 | true | 11/51 | pompe | yes |
| ep.ep_station_pompage | Station de pompage | 24 | true | 10/61 | station_de_pompage | yes |
| ep.ep_puit | Puits | 25 | false | 4/42 | puit | yes |
| ep.ep_st_demineralisation | Station de déminéralisation | 26 | false | 11/54 | - | no |
| ep.tn | TN | 27 | true | 0/19 | - | no |
| ep.anomalie_conduite | Anomalie conduite | 28 | true | 1/21 | - | no |
| ep.ep_regard | Regard (polygone) | 29 | true | 0/73 | - | yes |
| ep.borne_onep | Borne ONEP | 30 | true | 3/26 | borne_onep | yes |
| ep.bouche_a_cles | Bouche à clé | 31 | true | 3/28 | bouche_a_cles | yes |
| ep.onep_db | ONEP DB | 32 | false | 0/15 | - | no |
| ep.autre_objet | Autre objet EP | 33 | true | 4/21 | autre_objet | yes |
| ep.statistique_conduite | Statistique conduite | 34 | false | 0/7 | - | no |
| ep.statistique_conduite_segment | Segment statistique conduite | 35 | false | 0/10 | - | no |

## Formulaires visibles avec gap technique
| Table | Titre | Ordre | Champs | SrmConfig | Endpoint |
| --- | --- | --- | --- | --- | --- |
| ep.ep_bache | Bâche | 13 | 9/51 | no | no |
| ep.voie | Voie | 18 | 1/17 | no | no |
| ep.tn | TN | 27 | 0/19 | no | no |
| ep.anomalie_conduite | Anomalie conduite | 28 | 1/21 | no | no |
| ep.ep_regard | Regard (polygone) | 29 | 0/73 | no | yes |
