    ...
    "Eau Potable": {
      ...
      "entities": {
        "Vanne": {
          ...
          "fields": ["ep_num","ep_type","ep_modele","ep_marque","ep_diam","ep_ref_regard","ep_sens_ferm","ep_manoeuvre","ep_etat","ep_sectionnement","emplacement","ep_ref","ref_rue","ep_entreprise","ep_ref_marche","etage_aqua","secteur_aqua","ep_statut","observation","ep_coor_x","ep_coor_y","ep_coor_z"],
        },
        "Vanne de Vidange": {
          "tableName": "vanne_de_vidange", "schema": "ep",
          "geometryType": "Point", "hasZ": false, "maxPhotos": 4,
          "typeField": "ep_type", "typeOptions": [],
          "fields": ["ep_num","ep_type","ep_modele","ep_marque","ep_diam","ep_etat","emplacement","ep_ref","ref_rue","ep_entreprise","ep_ref_marche","etage_aqua","secteur_aqua","ep_statut","observation","ep_coor_x","ep_coor_y","ep_coor_z"],
        },
        "Ventouse": {
        ...
        "Hydrant": {
          ...
          "fields": ["ep_num","ep_type","ep_modele","ep_marque","ep_diam","ep_pression","ep_etat","emplacement","ep_ref","ref_rue","ep_entreprise","ep_ref_marche","etage_aqua","secteur_aqua","ep_statut","observation","ep_coor_x","ep_coor_y","ep_coor_z"],
        },
        "Borne Fontaine": {
          "tableName": "borne_fontaine", "schema": "ep",
          "geometryType": "Point", "hasZ": false, "maxPhotos": 4,
          "typeField": "ep_type", "typeOptions": [],
          "fields": ["ep_num","ep_type","ep_etat","ep_diam","emplacement","ref_rue","etage_aqua","secteur_aqua","ep_statut","observation","ep_coor_x","ep_coor_y","ep_coor_z"],
        },
        "Borne ONEP": {
          "tableName": "borne_onep", "schema": "ep",
          "geometryType": "Point", "hasZ": false, "maxPhotos": 4,
          "typeField": "ep_type", "typeOptions": [],
          "fields": ["ep_num","ep_type","ep_etat","emplacement","ref_rue","etage_aqua","secteur_aqua","ep_statut","observation","ep_coor_x","ep_coor_y","ep_coor_z"],
        },
        "Bouche à Clé": {
        ...
        "Compteur Réseau": {
          ...
          "geometryType": "Point", "hasZ": false, "maxPhotos": 4,
          "typeField": "ep_type", "typeOptions": [],
          "fields": ["ep_num","ep_type","ep_calibre","ep_numero","ep_etat","emplacement","ref_rue","etage_aqua","secteur_aqua","ep_statut","observation","ep_coor_x","ep_coor_y","ep_coor_z"],
        },
        "Compteur Abonné": {
        ...
        "Cône de Réduction": {
          ...
          "fields": ["ep_num","ep_diam_amont","ep_diam_aval","ep_etat","emplacement","ref_rue","etage_aqua","secteur_aqua","ep_statut","observation","ep_coor_x","ep_coor_y","ep_coor_z"],
        },
        "Centre Tampon": {
        ...
        "Obturateur": {
          ...
          "geometryType": "Point", "hasZ": false, "maxPhotos": 4,
          "typeField": "ep_type", "typeOptions": [],
          "fields": ["ep_num","ep_type","ep_diam","ep_etat","emplacement","ref_rue","etage_aqua","secteur_aqua","ep_statut","observation","ep_coor_x","ep_coor_y","ep_coor_z"],
        },
        ...
        "Noeud": {
          ...
          "geometryType": "Point", "hasZ": false, "maxPhotos": 4,
          "typeField": "ep_type", "typeOptions": [],
          "fields": ["ep_num","ep_type","emplacement","ref_rue","etage_aqua","secteur_aqua","ep_statut","observation","ep_coor_x","ep_coor_y","ep_coor_z"],
        },
        "Réservoir": {
          "tableName": "reservoir", "schema": "ep",
          "geometryType": "Point", "hasZ": false, "maxPhotos": 4,
          "typeField": "ep_type", "typeOptions": [],
          "fields": ["ep_num","ep_type","ep_capacite","ep_cote_radier","ep_cote_trop_plein","ep_cote_tn","ep_etat","emplacement","ref_rue","etage_aqua","secteur_aqua","ep_statut","observation","ep_coor_x","ep_coor_y","ep_coor_z"],
        },
        "Station de Pompage": {
          "tableName": "station_de_pompage", "schema": "ep",
          "geometryType": "Point", "hasZ": false, "maxPhotos": 4,
          "typeField": "ep_type", "typeOptions": [],
          "fields": ["ep_num","ep_type","ep_nb_pompes","ep_capacite","ep_etat","emplacement","ref_rue","etage_aqua","secteur_aqua","ep_statut","observation","ep_coor_x","ep_coor_y","ep_coor_z"],
        },
        "Forage": {
          "tableName": "forage", "schema": "ep",
          "geometryType": "Point", "hasZ": false, "maxPhotos": 4,
          "typeField": "ep_type", "typeOptions": [],
          "fields": ["ep_num","ep_type","ep_profondeur","ep_debit","ep_etat","emplacement","ref_rue","etage_aqua","secteur_aqua","ep_statut","observation","ep_coor_x","ep_coor_y","ep_coor_z"],
        },
        "Puit": {
          "tableName": "puit", "schema": "ep",
          "geometryType": "Point", "hasZ": false, "maxPhotos": 4,
          "typeField": "ep_type", "typeOptions": [],
          "fields": ["ep_num","ep_type","ep_profondeur","ep_etat","emplacement","ref_rue","etage_aqua","secteur_aqua","ep_statut","observation","ep_coor_x","ep_coor_y","ep_coor_z"],
        },
        "Pompe": {
          "tableName": "pompe", "schema": "ep",
          "geometryType": "Point", "hasZ": false, "maxPhotos": 4,
          "typeField": "ep_type", "typeOptions": [],
          "fields": ["ep_num","ep_type","ep_puissance","ep_debit","ep_etat","emplacement","ref_rue","etage_aqua","secteur_aqua","ep_statut","observation","ep_coor_x","ep_coor_y","ep_coor_z"],
        },
        "Regard EP": {
          "tableName": "regard_ep", "schema": "ep",
          "geometryType": "Polygon", "hasZ": true, "isPolygon": true, "maxPhotos": 4,
          "typeField": "ep_type", "typeOptions": [],
          "fields": ["ep_num","ep_type","ep_forme","ep_longueur","ep_largeur","ep_cote_tampon","ep_cote_radier","ep_cote_fil_eau","ep_etat","emplacement","ref_rue","etage_aqua","secteur_aqua","ep_statut","observation","ep_coor_x","ep_coor_y","ep_coor_z"],
        },
        "Conduite Terrain": {
          ...
          "fields": ["ep_num","ep_type","ep_diam","ep_mat","ep_long_c","ep_long_r","ep_profondeur","ep_classe_conduite","emplacement","zamont","zaval","pente","zalerte","ref_rue","ep_entreprise","ep_ref_marche","ep_sect_hydro","ep_etage_p","etage_aqua","secteur_aqua","ep_statut"],
        },
        "Branchement EP": {
          "tableName": "branchement", "schema": "ep",
          "geometryType": "LineString", "hasZ": false, "isLine": true, "maxPhotos": 4,
          "typeField": "ep_type", "typeOptions": [],
          "fields": ["ep_num","ep_type","ep_diam","ep_mat","ep_long","ep_etat","emplacement","ref_rue","etage_aqua","secteur_aqua","ep_statut","observation"],
        },
        "Traverse": {
          "tableName": "traverse", "schema": "ep",
          "geometryType": "LineString", "hasZ": false, "isLine": true, "maxPhotos": 4,
          "typeField": "ep_type", "typeOptions": [],
          "fields": ["ep_num","ep_type","ep_long","ep_etat","emplacement","ref_rue","etage_aqua","secteur_aqua","ep_statut","observation"],
        },
        "Planche": {
        ...
        "Autre Objet EP": {
          ...
          "fields": ["type_objet","ep_diam","ref_rue","observation","ep_coor_z"],
        },
      },
    },
