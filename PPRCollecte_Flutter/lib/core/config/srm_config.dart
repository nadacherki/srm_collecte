...
class SrmConfig {
    ...
    "Eau Potable": {
      ...
      "entities": {
        ...
        "Cône de Réduction": {
          ...
          "requiredFields": ["ep_diam_amont","ep_diam_aval","ep_etat","conformite_plan"],
        },
        "Centre Tampon": {
        ...
        "Regard EP": {
          ...
          "requiredFields": ["ep_forme","ep_etat","conformite_plan"],
        },
        "Conduite Terrain": {
  ...
  /// uuid est ici aussi (Uuid().v4() auto), il ne doit PAS apparaître dans fields
