-- PostgreSQL import bundle generated from origin/codex/automation
-- Run this file with PostgreSQL or psql to create the generated schemas and tables.

-- Begin asst_bassin.sql (asst.bassin)
...
-- Begin asst_branchement.sql (asst.branchement)
...
-- End asst_branchement.sql

-- Begin asst_canalisation_bureau.sql (asst.canalisation_bureau)
...
-- End asst_canalisation_bureau.sql

-- Begin asst_canalisation_reutilisation.sql (asst.canalisation_reutilisation)
...
-- End asst_canalisation_reutilisation.sql

-- Begin asst_canalisation_terrain.sql (asst.canalisation_terrain)
...
-- End asst_canalisation_terrain.sql

-- Begin asst_equipement.sql (asst.equipement)
...
-- End asst_equipement.sql

-- Begin asst_ouvrage.sql (asst.ouvrage)
...
-- End asst_ouvrage.sql

-- Begin asst_regard.sql (asst.regard)
...
-- Begin asst_regard_branchement.sql (asst.regard_branchement)
...
-- End asst_regard_branchement.sql

-- Begin asst_station.sql (asst.station)
...
-- End asst_station.sql

-- Begin elec_cellule.sql (elec.cellule)
...
-- End elec_cellule.sql

-- Begin elec_coffret_bt.sql (elec.coffret_bt)
...
-- End elec_coffret_bt.sql

-- Begin elec_depart_bt.sql (elec.depart_bt)
...
-- End elec_depart_bt.sql

-- Begin elec_depart_hta.sql (elec.depart_hta)
...
-- End elec_depart_hta.sql

-- Begin elec_noeud_raccord.sql (elec.noeud_raccord)
...
-- End elec_noeud_raccord.sql

-- Begin elec_point_desserte.sql (elec.point_desserte)
...
-- End elec_point_desserte.sql

-- Begin elec_poste.sql (elec.poste)
...
-- Begin elec_support.sql (elec.support)
...
-- End elec_support.sql

-- Begin elec_transformateur.sql (elec.transformateur)
...
-- End elec_transformateur.sql

-- Begin elec_troncon_bt.sql (elec.troncon_bt)
...
-- End elec_troncon_bt.sql

-- Begin elec_troncon_hta.sql (elec.troncon_hta)
...
-- End elec_troncon_hta.sql

-- Begin ep_anomalie_conduite.sql (ep.anomalie_conduite)
...
-- End ep_anomalie_conduite.sql

-- Begin ep_bache.sql (ep.ep_bache)
...
-- Begin ep_bouche_arro.sql (ep.ep_bouche_arro)
...
-- End ep_bouche_arro.sql

-- Begin ep_branchement.sql (ep.ep_branchement)
...
-- End ep_branchement.sql

-- Begin ep_brc_pt.sql (ep.ep_brc_pt)
...
-- Begin ep_centre_tampon.sql (ep.centre_tampon)
...
-- End ep_centre_tampon.sql

-- Begin ep_compteur_i.sql (ep.ep_compteur_i)
...
-- End ep_compteur_i.sql

-- Begin ep_conduite_bureau.sql (ep.ep_conduite)
...
-- End ep_conduite_bureau.sql

-- Begin ep_conduite_terrain.sql (ep.conduite_terrain)
...
-- End ep_conduite_terrain.sql

-- Begin ep_cone_reduc.sql (ep.ep_cone_reduc)
...
-- End ep_cone_reduc.sql

-- Begin ep_forage.sql (ep.ep_forage)
...
-- Begin ep_hydrant.sql (ep.ep_hydrant)
...
-- Begin ep_obturateur.sql (ep.ep_obturateur)
...
-- End ep_obturateur.sql

-- Begin ep_pompe.sql (ep.ep_pompe)
...
-- Begin ep_reduc_pres.sql (ep.ep_reduc_pres)
...
-- End ep_reduc_pres.sql

-- Begin ep_regard.sql (ep.ep_regard)
...
-- Begin ep_regard_pret.sql (ep.regard_pret)
...
-- End ep_regard_pret.sql

-- Begin ep_reservoir.sql (ep.ep_reservoir)
...
-- End ep_reservoir.sql

-- Begin ep_station_pompage.sql (ep.ep_station_pompage)
...
-- End ep_station_pompage.sql

-- Begin ep_tn.sql (ep.tn)
...
-- Begin ep_traversee.sql (ep.ep_traversee)
...
-- End ep_traversee.sql

-- Begin ep_vanne.sql (ep.ep_vanne)
...
-- Begin ep_ventouse.sql (ep.ep_ventouse)
...
-- Begin ep_vidange.sql (ep.ep_vidange)
