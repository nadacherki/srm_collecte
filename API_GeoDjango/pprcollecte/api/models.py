...
class EpBorneFontaine(SrmTrackedModel):
    ...
    ep_type = models.CharField(max_length=254, null=True, blank=True)
    ep_diam = models.CharField(max_length=254, null=True, blank=True)
    mat_brts = models.CharField(max_length=400, null=True, blank=True)
    ep_etat = models.CharField(max_length=254, null=True, blank=True)
    marque = models.CharField(max_length=254, null=True, blank=True)
    emplacement = models.CharField(max_length=254, null=True, blank=True)
    ep_ref = models.CharField(max_length=254, null=True, blank=True)
...
class EpCompteurAbonne(SrmTrackedModel):
    ...
    ref = models.CharField(max_length=400, null=True, blank=True)
    sect = models.CharField(max_length=400, null=True, blank=True)
    tour = models.CharField(max_length=400, null=True, blank=True)
    abon = models.CharField(max_length=400, null=True, blank=True)
    ep_coor_x = models.FloatField(null=True, blank=True)
    ep_coor_y = models.FloatField(null=True, blank=True)
    nom = models.CharField(max_length=400, null=True, blank=True)
    date_pose = models.CharField(max_length=400, null=True, blank=True)
    date_releve = models.CharField(max_length=400, null=True, blank=True)
    consommation = models.CharField(max_length=400, null=True, blank=True)
    sect_hydr = models.CharField(max_length=400, null=True, blank=True)
    zone = models.CharField(max_length=400, null=True, blank=True)
    cin = models.CharField(max_length=400, null=True, blank=True)
    adresse = models.CharField(max_length=400, null=True, blank=True)
    type_abonnement = models.CharField(max_length=400, null=True, blank=True)
    num_contrat = models.CharField(max_length=400, null=True, blank=True)
    num_compteur = models.CharField(max_length=400, null=True, blank=True)
    etat_abonnement = models.CharField(max_length=400, null=True, blank=True)
    type_cpt = models.CharField(max_length=400, null=True, blank=True)
    anne_fabr_compt = models.CharField(max_length=400, null=True, blank=True)
    diametre = models.CharField(max_length=400, null=True, blank=True)
    ep_date_insertion = models.DateField(null=True, blank=True)
    anomalie_rdo = models.CharField(max_length=400, null=True, blank=True)
    ...
    commune = models.CharField(max_length=400, null=True, blank=True)
    ...
    ep_anomalie = models.CharField(max_length=400, null=True, blank=True)
    mode_localisation = models.CharField(max_length=400, null=True, blank=True)
    ancien_ref_sap = models.CharField(max_length=400, null=True, blank=True)
    id_geo = models.CharField(max_length=400, null=True, blank=True)
    ancienne_police = models.CharField(max_length=400, null=True, blank=True)
    geom = models.PointField(srid=26191, dim=3, null=True, blank=True)
    id_commune = models.IntegerField(null=True, blank=True)
    id_province = models.IntegerField(null=True, blank=True)
    id_user_creat = models.IntegerField(null=True, blank=True)
    ...
    ep_coor_z = models.FloatField(null=True, blank=True)
    id_zone = models.IntegerField(null=True, blank=True)
    photo_1 = models.CharField(max_length=400, null=True, blank=True)
    photo_2 = models.CharField(max_length=400, null=True, blank=True)
    photo_3 = models.CharField(max_length=400, null=True, blank=True)
    photo_4 = models.CharField(max_length=400, null=True, blank=True)
    ...
    diametre_calibre_terrain = models.CharField(max_length=400, null=True, blank=True)
    diametre_conduite = models.CharField(max_length=400, null=True, blank=True)
    ep_diam = models.CharField(max_length=400, null=True, blank=True)
    id_mission = models.IntegerField(null=True, blank=True)

    class Meta:
        managed = False
        db_table = '"ep"."ep_brc_pt"'


class EpCompteurReseau(SrmTrackedModel):
    fid = models.AutoField(primary_key=True)
    uuid = models.UUIDField(null=True, blank=True)
    ep_num = models.CharField(max_length=400, null=True, blank=True)
    ep_type = models.CharField(max_length=400, null=True, blank=True)
    ep_code_ter = models.CharField(max_length=400, null=True, blank=True)
    ep_modele = models.CharField(max_length=400, null=True, blank=True)
    ep_calibre = models.CharField(max_length=400, null=True, blank=True)
    ep_sourc_alim = models.CharField(max_length=400, null=True, blank=True)
    ep_ref_regard = models.CharField(max_length=400, null=True, blank=True)
    ep_releve = models.CharField(max_length=400, null=True, blank=True)
    ep_res_deserv = models.CharField(max_length=400, null=True, blank=True)
    ep_alti = models.FloatField(null=True, blank=True)
    ep_ref_rue = models.CharField(max_length=400, null=True, blank=True)
    ep_secteur_com = models.CharField(max_length=400, null=True, blank=True)
    ep_ref = models.CharField(max_length=400, null=True, blank=True)
    ep_date_pose = models.DateField(null=True, blank=True)
    ep_entreprise = models.CharField(max_length=400, null=True, blank=True)
    ep_agent = models.CharField(max_length=400, null=True, blank=True)
    ep_ref_marche = models.CharField(max_length=400, null=True, blank=True)
    ep_zone_hydro = models.CharField(max_length=400, null=True, blank=True)
    ep_secteur_hydro = models.CharField(max_length=400, null=True, blank=True)
    etage_aqua = models.CharField(max_length=400, null=True, blank=True)
    secteur_aqua = models.CharField(max_length=400, null=True, blank=True)
    ep_ref_mm = models.CharField(max_length=400, null=True, blank=True)
    ep_mm = models.CharField(max_length=400, null=True, blank=True)
    ep_statut = models.CharField(max_length=400, null=True, blank=True)
    ep_n_serie = models.CharField(max_length=400, null=True, blank=True)
    ep_marque = models.CharField(max_length=400, null=True, blank=True)
    ep_compt_fonction = models.CharField(max_length=400, null=True, blank=True)
    ep_date_insertion = models.DateField(null=True, blank=True)
    altitute = models.FloatField(null=True, blank=True)
    ep_agent_crea = models.CharField(max_length=400, null=True, blank=True)
    sec_com = models.CharField(max_length=400, null=True, blank=True)
    sect_hydr = models.CharField(max_length=400, null=True, blank=True)
    zone = models.CharField(max_length=400, null=True, blank=True)
    tf = models.CharField(max_length=400, null=True, blank=True)
    province = models.CharField(max_length=400, null=True, blank=True)
    commune = models.CharField(max_length=400, null=True, blank=True)
    ep_conf_plan = models.CharField(max_length=400, null=True, blank=True)
    ep_observation = models.CharField(max_length=400, null=True, blank=True)
    ...
    ep_coor_z = models.FloatField(null=True, blank=True)
    mode_localisation = models.CharField(max_length=400, null=True, blank=True)
    emplacement = models.CharField(max_length=400, null=True, blank=True)
    geom = models.PointField(srid=26191, dim=3, null=True, blank=True)
    id_commune = models.IntegerField(null=True, blank=True)
    id_province = models.IntegerField(null=True, blank=True)
    id_user_creat = models.IntegerField(null=True, blank=True)
